...
export default class QueryController {
    ...
    //     for (var q in query){
    //         console.log(query[q]);
    //         if(query[q] instanceof Object ||query[q] instanceof Array){
    //             this.removeEmptyField(query[q]);
    //         }
    //         if ((query[q] instanceof Object && (Object.keys(query[q]).length == 0 ))||
